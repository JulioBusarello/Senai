...
#1
SELECT localizacao FROM departamento WHERE id_departamento = 30;

#2
SELECT id_empregado, nm_empregado, funcao, lider, data_contratacao, salario, comissao FROM empregado WHERE funcao like 'ANALISTA';
...
#5
SELECT id_empregado 'NÚMERO IDENTIFICADOR', nm_empregado NOME, funcao FUNÇÃO, lider LIDER, data_contratacao 'DATA DE CONTRATAÇÃO', salario SALÁRIO, comissao COMISSAO FROM empregado WHERE funcao like 'GERENTE';

#6
SELECT id_empregado, nm_empregado, funcao, lider, data_contratacao, salario, comissao FROM empregado WHERE nm_empregado LIKE '%A%';

#7
SELECT nm_empregado, id_departamento FROM empregado WHERE id_departamento IN (10,30) ORDER BY nm_empregado ASC;

#8
SELECT id_empregado, nm_empregado, funcao, lider, data_contratacao, salario, comissao FROM empregado WHERE data_contratacao LIKE '1982%';

#9
SELECT id_empregado, nm_empregado, funcao, lider, data_contratacao, salario, comissao FROM empregado WHERE comissao >= 500 ORDER BY nm_empregado ASC;

#10
SELECT id_empregado, nm_empregado, funcao, lider, data_contratacao, salario, comissao FROM empregado WHERE salario < 1300 ORDER BY salario DESC;